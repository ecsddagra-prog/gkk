...
export default function ServiceCard({ service, category, onBook }) {
    const CardContent = () => (
        <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden cursor-pointer group h-full flex flex-col">
            {/* Service Image Placeholder */}
            <div className="relative h-48 bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center overflow-hidden flex-shrink-0">
            ...
            <div className="p-4 flex flex-col flex-1">
                ...
                {/* Book Now Button */}
                <button className="w-full py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition font-medium text-sm mt-2">
                    Book Now
                </button>
            </div>
        </div>
